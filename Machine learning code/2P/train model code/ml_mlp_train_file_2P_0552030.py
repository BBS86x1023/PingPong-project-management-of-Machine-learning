...
model.add(Neurons(units=30, activation=Relu()))
...
params = {"learning_rate": 0.0001, "n_epoch": 2000, "print_rate": 100}
## MSE : 均方誤差
loss = MSE()
## 印出多層神經網路架構
print(model.layers)
...
\\game\\MLGame-master\\games\\pingpong\\ml\\mlp_model_2P_0552030_1.sav"
